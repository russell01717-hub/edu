      ...
      {showForm && (
        <form onSubmit={create} className="bg-white p-4 lg:p-5 rounded-2xl shadow-sm border border-gray-100 mb-6 flex flex-col sm:flex-row gap-3 items-end animate-slideIn">
          ...
          <div className="w-full sm:w-40">
            <label className="text-xs text-gray-400 block mb-1 font-medium">Summa (so'm)</label>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm min-w-[600px]">
            ...
            <tbody>
              ...
              {payments.length === 0 && <tr><td colSpan={6} className="py-12 text-center text-gray-400"><span className="text-3xl block mb-2">💳</span>To'lovlar mavjud emas</td></tr>}
            </tbody>
          </table>
        </div>
      </div>
